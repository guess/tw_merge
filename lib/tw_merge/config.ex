defmodule TwMerge.Config do
  ...
  defp default_theme do
    %{
      ...
      brightness: [&number?/1, &arbitrary_number?/1],
      contrast: [&number?/1, &arbitrary_number?/1],
      grayscale: ["", "0", &arbitrary_value?/1],
      hueRotate: [&number?/1, &arbitrary_value?/1],
      invert: ["", "0", &arbitrary_value?/1],
      opacity: [&number?/1, &arbitrary_number?/1],
      saturate: [&number?/1, &arbitrary_number?/1],
      scale: [&number?/1, &arbitrary_number?/1],
      sepia: ["", "0", &arbitrary_value?/1],
      skew: [&number?/1, &arbitrary_value?/1],
      translate: [&arbitrary_value?/1, &number?/1],
      margin: ["auto", &arbitrary_value?/1, &arbitrary_variable_length?/1, &number?/1],
      padding: [&arbitrary_value?/1, &arbitrary_variable_length?/1, &number?/1],
      gap: [&arbitrary_value?/1, &number?/1],
      inset: ["auto", &fraction?/1, "full", &arbitrary_value?/1, &number?/1],
      gradientColorStops: [&any?/1],
      gradientColorStopPositions: [&percent?/1, &arbitrary_length?/1],
      space: [&arbitrary_value?/1, &number?/1]
    }
  end
  ...
  defp settings do
    %{
      groups: %{
        ...
        "placeholder-color" => %{"placeholder" => [&from_theme(&1, "color")]},
        ...
        "bg-color" => %{"bg" => [&from_theme(&1, "color")]},
        ...
        "rounded" => %{"rounded" => [&from_theme(&1, "radius")]},
        "rounded-s" => %{"rounded-s" => [&from_theme(&1, "radius")]},
        "rounded-e" => %{"rounded-e" => [&from_theme(&1, "radius")]},
        "rounded-t" => %{"rounded-t" => [&from_theme(&1, "radius")]},
        "rounded-r" => %{"rounded-r" => [&from_theme(&1, "radius")]},
        "rounded-b" => %{"rounded-b" => [&from_theme(&1, "radius")]},
        "rounded-l" => %{"rounded-l" => [&from_theme(&1, "radius")]},
        "rounded-ss" => %{"rounded-ss" => [&from_theme(&1, "radius")]},
        "rounded-se" => %{"rounded-se" => [&from_theme(&1, "radius")]},
        "rounded-ee" => %{"rounded-ee" => [&from_theme(&1, "radius")]},
        "rounded-es" => %{"rounded-es" => [&from_theme(&1, "radius")]},
        "rounded-tl" => %{"rounded-tl" => [&from_theme(&1, "radius")]},
        "rounded-tr" => %{"rounded-tr" => [&from_theme(&1, "radius")]},
        "rounded-br" => %{"rounded-br" => [&from_theme(&1, "radius")]},
        "rounded-bl" => %{"rounded-bl" => [&from_theme(&1, "radius")]},
        ...
        "border-color" => %{"border" => [&from_theme(&1, "color")]},
        "border-color-x" => %{"border-x" => [&from_theme(&1, "color")]},
        "border-color-y" => %{"border-y" => [&from_theme(&1, "color")]},
        "border-color-t" => %{"border-t" => [&from_theme(&1, "color")]},
        "border-color-r" => %{"border-r" => [&from_theme(&1, "color")]},
        "border-color-b" => %{"border-b" => [&from_theme(&1, "color")]},
        "border-color-l" => %{"border-l" => [&from_theme(&1, "color")]},
        "divide-color" => %{"divide" => [&from_theme(&1, "color")]},
        ...
        "outline-color" => %{"outline" => [&from_theme(&1, "color")]},
        ...
        "accent" => %{"accent" => ["auto", &from_theme(&1, "color")]},
        ...
        "caret-color" => %{"caret" => [&from_theme(&1, "color")]},
